...
public class PricingCalculatorPage {
    ...
    private static final String DISMISS_BUTTON_XPATH = "//*[@id='dismiss-button']";
    ...
    @FindBy(xpath = DISMISS_BUTTON_XPATH)
...
//        new WebDriverWait(driver, Duration.ofSeconds(10))
//                .until(ExpectedConditions.elementToBeClickable(By.xpath(DISMISS_BUTTON_XPATH)));
//        closeAd.click();
...
//        actions.click().perform();
    ...
    private void setMachineFamily(String machineFamilySelect) {
        new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.elementToBeClickable(By.xpath(MACHINE_FAMILY_SELECT_XPATH)))
                .click();
